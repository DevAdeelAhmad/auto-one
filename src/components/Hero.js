            ...
            <div className='flex-[0.4]'>
                <div className='flex flex-col w-full h-full lg:justify-center mt-8 lg:mt-0 items-center lg:items-start gap-y-10 lg:ml-32'>
                    <div className='flex flex-col gap-y-5'>
                        <h1 className='text-3xl lg:text-5xl 2xl:text-6xl flex flex-col text-center lg:text-start font-semibold'><span>One <span className="font-bold">Platform</span></span><span> Where<span className='italic text-primary'> Lots </span>Of</span> <span> Options Are There</span></h1>
